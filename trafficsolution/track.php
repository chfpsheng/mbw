...
$openChatExternal = !empty($_GET["ovloe"]) || (((!empty($CONFIG["gl_moce"]) && $isMobile) || ($isMobile && !$isTablet)));
$openTicketExternal = $openChatExternal; // !empty($_GET["ovloe"]) || $openChatExternal;
